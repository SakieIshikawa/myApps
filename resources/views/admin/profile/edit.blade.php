  ...
  <div class="radio-tile-group">
    <div class="input-container">
      ...
      <div class="radio-tile">
        ...
        <label for="walk" class="radio-tile-label">男</label>
      </div>
    </div>
    ...
    <div class="input-container">
      ...
      <div class="radio-tile">
        ...
        <label for="bike" class="radio-tile-label">女</label>
      </div>
    </div>

    
                      <!-- <div class="col-md-2">
                        <input type='' name="gender" class="form-control" value="{{ $profile_form->gender }}">
